...
This document is mostly for graduate students and postdocs.
...
8. Timeline for your deliverables: how long do yo expect to work on each, how much time do you need on them? You can break down the deliverables into pieces, including specific aims. Example: Months 1-3: literature search on existing tools. Months 4-7 Implementation of model in Specific Aim 1,...You can be as descriptive and detailed as you want, this plan will help you to guide your research to completion
...
The manuscript deliverable must be a good version of the manuscript that is complete, has been proof-read by you, is properly cited. You should have given it a lot of thought and work to produce the version that you will share with your co-authors. You should also use the resources of the writing center to produce this version

- Another common deliverable will be open-source software. Keep in mind that there is a huge gap between code that runs, and code that is suitable for publication and you should consider this in your timeline. Follow all reproducibility practices and best computing practices. Keeping clean, properly documented and readable code is not fun and nobody likes to do it. But keep in mind that suboptimal code will not be deemed suitable for publication

- The deliverables must be up to standards to the lab guidelines of reproducibility, clear communication, etc (see lab guidelines)